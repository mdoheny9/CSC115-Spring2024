...
/* 
		...
		result = A1Exercises.greatestCommonDenominator(7, 1);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		result = A1Exercises.greatestCommonDenominator(2, 6);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
...
*/
	...
	public static void testCountMatches() {
		...
		System.out.println("Testing countMatches(arr2, 6)");
		result = A1Exercises.countMatches(arr2, 6);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
