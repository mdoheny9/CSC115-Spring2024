public class A4Tester11 {
	...
	public static void testCountScoresAboveX() {
		...
		result = A4Exercises.countScoresAboveX(list4, 30);
		expected = 0;
		displayResults(result == expected, "countScoresAboveX(list1, 30)");

		result = A4Exercises.countScoresAboveX(list2, 100);
		expected = 0;
	...
	public static void testDistanceAway() {
		...
		result = A4Exercises.distanceAway(list4, c3);
		System.out.println(result);
		expected = -1;
		displayResults(result==expected, "distanceAway(list3, c3)");
	...
	public static void testListOfRecordBreakers() {
		...
		System.out.println(result);
		displayResults(equal(result,expected4), "listOfRecordBreakers(list3)");
