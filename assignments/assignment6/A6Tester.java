public class A6Tester {	
	...
	public static void eventLineTests() {
		...
		System.out.println("EXPECTED: 3, RESULT: " + eLine.peopleInLine());
		eLine.enterLine(p7);
		eLine.enterLine(p1);
		eLine.enterLine(p2);
		eLine.enterLine(p3);		
		displayResults(eLine.peopleInLine()==7, "people in line 5");
		System.out.println("EXPECTED: 7, RESULT: " + eLine.peopleInLine());
		System.out.println();
		try {
		...
		System.out.println("EXPECTED: 2, RESULT: " + eLine.peopleInLine());
