...
public class A2Tester {
	...
	public static void testMoneySpent() {
		...
		bidderName = new String("Ali");
		result = f0a.moneySpent(bidderName);
		expected = 0;
		displayResults(result==expected, "amount "+bidderName+" spent at f0a");

		bidderName = new String("Sam");
		result = f0b.moneySpent(bidderName);
		expected = 0;
		displayResults(result==expected, "amount "+bidderName+" spent at f0b");
	...
	public static void testMostExpensive() {
		...
		AuctionItem[] arr4 = {a3, a4, a5};

		Fundraiser f1 = new Fundraiser("Family Fundraiser", arr1);
		Fundraiser f2 = new Fundraiser("Fall Fundraiser", arr2);
		Fundraiser f3 = new Fundraiser("Team Fundraiser", arr3);
		Fundraiser f4 = new Fundraiser("Megans Awesome Fundraiser", arr4);
		...
		expected = a3;
		displayResults(result.equals(expected), "mostExpensive in f4");
	...
	public static void testAddToFundraiser() {
		...
		f0.addToFundraiser(a5);
		result = f0.getItems();
		expected = arr0AfterAdd;
		displayResults(equal(result,expected), "added a5 to f0");
	...
	public static void testTotalMoneyRaised() {
		...
		Fundraiser[] fundraisers3 = {f0a};
		Fundraiser[] fundraisers4 = {f0b};
		...
		// System.out.println(result);
		expected = 0;
		displayResults(result==expected, "total money raised in fundraisers3");
	...
	public static void testTotalSpent() {
		...
		// System.out.println(result);
		expected = 0;
		displayResults(result==expected, "total spent by "+toFind+" in fundraisers3");
	...
	public static void testMostExpensiveItems() {
		...
		result = A2Exercises.mostExpensiveItems(fundraisers3);
		AuctionItem[] expected3 = {a1};
		displayResults(equal(result, expected3), "most expensive items in fundraisers3");
	...
	public static void testAverageOfMostExpensive() {
		...
		AuctionItem[] arr2 = {a2, a3, a4, a5};
		AuctionItem[] arr3 = {a6, a7, a8, a9, a10};		
		AuctionItem[] arr4 = {a1, a2, a3};
		
		Fundraiser f1 = new Fundraiser("Family Fundraiser", arr1);
		Fundraiser f2 = new Fundraiser("Fall Fundraiser", arr2);
		Fundraiser f3 = new Fundraiser("Team Fundraiser", arr3);
		Fundraiser f4 = new Fundraiser("Epic Pogchamp Fundraiser", arr4);
		
		Fundraiser[] fundraisers0 = {};
		Fundraiser[] fundraisers1 = {f1, f2};
		Fundraiser[] fundraisers2 = {f3, f2, f1};
		Fundraiser[] fundraisers4 = {f4};
		...
		result = A2Exercises.averageOfMostExpensive(fundraisers4);
		expected = 220;
		displayResults(Math.abs(result-expected)<THRESHOLD, "average of expensive items in fundraisers4");
